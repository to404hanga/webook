...
func (mr *MockInteractiveServiceMockRecorder) CancelLike(c, biz, id, uid interface{}) *gomock.Call {
...
func (mr *MockInteractiveServiceMockRecorder) Like(c, biz, id, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
