...
func (m *MockRankingRepository) ReplaceTopN(ctx context.Context, articles []domain.Article) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReplaceTopN", ctx, articles)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReplaceTopN indicates an expected call of ReplaceTopN.
func (mr *MockRankingRepositoryMockRecorder) ReplaceTopN(ctx, articles interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReplaceTopN", reflect.TypeOf((*MockRankingRepository)(nil).ReplaceTopN), ctx, articles)
}
