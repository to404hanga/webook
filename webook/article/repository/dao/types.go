...
//go:generate mockgen -source=./types.go -destination=./mocks/article.mock.go -package=daomocks ArticleAuthorDAO
type ArticleAuthorDAO interface {
	Create(ctx context.Context, article Article) (int64, error)
	Update(ctx context.Context, article Article) error
}

//go:generate mockgen -source=./types.go -destination=./mocks/article.mock.go -package=daomocks ArticleReaderDAO
